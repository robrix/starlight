...
gravitation :: (Metric v, Epsilon a, Floating a) => Kilo Grams a -> Kilo Grams a -> v (Metres a) -> v (Metres a) -> v (Newtons a)
gravitation m1 m2 p1 p2 = ((m1 .*. m2 ./. (p1 `qdU` p2)) .*. gravC) .*^ direction p2 p1
