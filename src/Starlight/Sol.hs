...
bodies orbits = bodies where
  ...
  bodies = Map.fromList
    [ let identifier = solI in (identifier,) Body
      ...
      , orientation = axisAngle (unit _x) (getRadians (convert @Degrees 7.25))
    ...
    , let identifier = solI :/ (199, "Mercury") in (identifier,) Body
      ...
      , orientation = axisAngle (unit _x) (getRadians (convert @Degrees 0.034))
    ...
    , let identifier = solI :/ (299, "Venus") in (identifier,) Body
      ...
      , orientation = axisAngle (unit _x) (getRadians (convert @Degrees 177.3))
    ...
    , let identifier = solI :/ (399, "Terra") in (identifier,) Body
      ...
      , orientation = axisAngle (unit _x) (getRadians (convert @Degrees 23.4392911))
    ...
    , let identifier = solI :/ (399, "Terra") :/ (301, "Luna") in (identifier,) Body
      ...
      , orientation = axisAngle (unit _x) (getRadians (convert @Degrees 6.687))
    ...
    , let identifier = solI :/ (499, "Mars") in (identifier,) Body
      ...
      , orientation = axisAngle (unit _x) (getRadians (convert @Degrees 25.19))
    ...
    , let identifier = solI :/ (499, "Mars") :/ (401, "Phobos") in (identifier,) Body
      ...
      , orientation = axisAngle (unit _x) (getRadians (convert @Degrees 0))
    ...
    , let identifier = solI :/ (499, "Mars") :/ (402, "Deimos") in (identifier,) Body
      ...
      , orientation = axisAngle (unit _x) (getRadians (convert @Degrees 0)) -- unknown
      , period      = (\ Orbit{period} -> period) (orbits Map.! identifier) -- synchronous
    ...
    , let identifier = solI :/ (599, "Jupiter") in (identifier,) Body
      ...
      , orientation = axisAngle (unit _x) (getRadians (convert @Degrees 3.13))
    ...
    , let identifier = solI :/ (599, "Jupiter") :/ (501, "Io") in (identifier,) Body
      ...
      , orientation = axisAngle (unit _x) (getRadians (convert @Degrees 1)) -- unknown
      , period      = (\ Orbit{period} -> period) (orbits Map.! identifier) -- synchronous
    ...
    , let identifier = solI :/ (599, "Jupiter") :/ (502, "Europa") in (identifier,) Body
      ...
      , orientation = axisAngle (unit _x) (getRadians (convert @Degrees 0.1))
      , period      = (\ Orbit{period} -> period) (orbits Map.! identifier) -- synchronous
    ...
    , let identifier = solI :/ (599, "Jupiter") :/ (503, "Ganymede") in (identifier,) Body
      ...
      , orientation = axisAngle (unit _x) (getRadians (convert @Degrees 0.33))
      , period      = (\ Orbit{period} -> period) (orbits Map.! identifier) -- synchronous
    ...
    , let identifier = solI :/ (699, "Saturn") in (identifier,) Body
      ...
      , orientation = axisAngle (unit _x) (getRadians (convert @Degrees 26.73))
    ...
    , let identifier = solI :/ (799, "Uranus") in (identifier,) Body
      ...
      , orientation = axisAngle (unit _x) (getRadians (convert @Degrees 97.77))
    ...
    , let identifier = solI :/ (899, "Neptune") in (identifier,) Body
      ...
      , orientation = axisAngle (unit _x) (getRadians (convert @Degrees 28.32))
    ...
    , let identifier = solI :/ (999, "Pluto") in (identifier,) Body
      ...
      , orientation = axisAngle (unit _x) (getRadians (convert @Degrees 122.53))
...
system = do
  ...
  let bodies = Starlight.Sol.bodies orbits
      placeholder orbit = Body
        ...
        , orientation = axisAngle (unit _x) (getRadians (convert @Degrees 5))
